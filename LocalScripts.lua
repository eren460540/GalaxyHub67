...
function createLockGui()
    ...
    local success, err = pcall(function()
        ...
        btn.ZIndex = 20
        local origS=btn.Size; local hoverS=UDim2.new(0,108,0,38); local clickS=UDim2.new(0,98,0,30)
...
local function createFloatButton()
    ...
    button.Size=UDim2.new(0,104,0,34)
    ...
    button.ZIndex = 20
    local oS=button.Size; local hS=UDim2.new(0,108,0,38); local cS=UDim2.new(0,98,0,30)
...
local function createAutoPlayGui()
    ...
    holder.Size=UDim2.new(0,104,0,34)
    ...
    title.Size=UDim2.new(1,0,0,10); title.Position=UDim2.new(0,0,0,1)
    ...
    divider.Size=UDim2.new(0,2,1,-13); divider.Position=UDim2.new(0.5,-1,0,11)
    ...
    local function makeHalf(text, xPos)
        local btn=Instance.new("TextButton")
        btn.Size=UDim2.new(0.5,-1,1,-13); btn.Position=UDim2.new(xPos,0,0,11)
    ...
    local oS=holder.Size; local hS=UDim2.new(0,108,0,38); local cS=UDim2.new(0,98,0,30)
